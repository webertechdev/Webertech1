            ...
            <div className="wtn-auth">
              {user ? (
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  {isAdmin && (
                    <>
                      <Link to="/control" style={{ padding: "6px 12px", borderRadius: "8px", textDecoration: "none", fontSize: "12.5px", fontWeight: "600", color: "#ec4899", border: "1.5px solid rgba(236,72,153,0.3)", transition: "all .15s" }}>Docs</Link>
              ...
              <>
                ...
                {isAdmin && (
                  <>
                    ...
                    <Link to="/control" className="wtn-mlink" onClick={() => setMenuOpen(false)}
