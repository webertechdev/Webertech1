...
export default function Hustle() {
  return (
    <ComingSoon
      ...
      description="Side hustles, reseller opportunities, affiliate programs & digital income streams — curated by WeberTech to help Kenyans earn online."
      firestoreCollection="hustle_waitlist"
