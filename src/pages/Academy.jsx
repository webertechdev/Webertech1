...
export default function Academy() {
  return (
    <ComingSoon
      ...
      description="Master digital skills — web development, graphic design, digital marketing & more. Earn certificates and build your freelance career."
      firestoreCollection="academy_waitlist"
