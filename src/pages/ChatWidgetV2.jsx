// src/pages/ChatWidgetV2.jsx
// WeberAI v2 - Provides Service Links & Instructions (No PDFs)

import { useState, useEffect, useRef } from "react";
import { collection, addDoc, serverTimestamp, doc, setDoc, getDoc, query, orderBy, getDocs } from "firebase/firestore";
...
const GREETING = {
  en: "👋 Hi! I'm WeberAI, your WeberTech assistant. I can help you find services, answer questions, and guide you to the right page. What do you need today?",
  sw: "👋 Habari! Mimi ni WeberAI, msaidizi wako wa WeberTech. Naweza kukusaidia kupata huduma, kujibu maswali, na kukuongoza kwenye ukurasa sahihi. Unahitaji nini leo?",
};

// Service links and instructions
const SERVICES = {
  cyber: {
    name: "Cyber Division",
    link: "/cyber",
...
export default function ChatWidgetV2() {
  ...
  const sendMessage = async (text) => {
    ...
    try {
      // Simulate AI response with service links
      let aiResponse = "";
      const lowerText = text.toLowerCase();

      if (lowerText.includes("cyber") || lowerText.includes("legal") || lowerText.includes("government")) {
        aiResponse = lang === "en"
          ? `📋 Looking for Cyber Division services? We offer legal documents, government services, printing, and professional writing.\n\n👉 Click below to explore:`
          : `📋 Unatafuta huduma za Cyber Division? Tunatoa hati za kisheria, huduma za serikali, uchapaji, na kuandika kwa kitaaluma.\n\n👉 Bofya hapo chini:`;
      } else if (lowerText.includes("bundle") || lowerText.includes("airtime") || lowerText.includes("data")) {
        aiResponse = lang === "en"
          ? `📱 Want to buy Safaricom bundles? We have airtime, data, and special packages.\n\n👉 Visit our bundles page:`
          : `📱 Unataka kununua bundle za Safaricom? Tunayo airtime, data, na paketi maalum.\n\n👉 Tembelea ukurasa wetu:`;
      } else if (lowerText.includes("academy") || lowerText.includes("course") || lowerText.includes("learn")) {
        aiResponse = lang === "en"
          ? `🎓 Interested in learning? Our Academy offers Forex trading and mentorship courses.\n\n👉 Explore our courses:`
          : `🎓 Unakamatia kujifunza? Academy yetu inatoa kozi za Forex na mentorship.\n\n👉 Jifunze zaidi:`;
      } else if (lowerText.includes("electronics") || lowerText.includes("hardware")) {
        aiResponse = lang === "en"
          ? `🖥️ Looking for electronics? We have hardware and accessories.\n\n👉 Browse our store:`
          : `🖥️ Unatafuta elektroniki? Tunayo hardware na accessories.\n\n👉 Tembelea duka:`;
      } else if (lowerText.includes("dev") || lowerText.includes("develop") || lowerText.includes("website")) {
        aiResponse = lang === "en"
          ? `💻 Need a website or app? Our Dev team builds custom solutions.\n\n👉 Learn more:`
          : `💻 Unahitaji website au app? Timu yetu ya Dev inajengea suluhisho maalum.\n\n👉 Jifunze zaidi:`;
      } else if (lowerText.includes("hustle") || lowerText.includes("startup") || lowerText.includes("business")) {
        aiResponse = lang === "en"
          ? `🚀 Starting a business? Hustle KE offers startup packages and tools.\n\n👉 Check it out:`
          : `🚀 Kuanza biashara? Hustle KE inatoa paketi za startup na zana.\n\n👉 Angalia:`;
      } else {
        aiResponse = lang === "en"
          ? `👋 I'm here to help! I can guide you to our services:\n\n• 📋 Cyber Division\n• 📱 Safaricom Bundles\n• 🎓 Academy\n• 🖥️ Electronics\n• 💻 Dev Services\n• 🚀 Hustle KE\n\nWhat interests you?`
          : `👋 Niko hapa kusaidia! Naweza kukuongoza kwenye huduma zetu:\n\n• 📋 Cyber Division\n• 📱 Safaricom Bundles\n• 🎓 Academy\n• 🖥️ Electronics\n• 💻 Dev Services\n• 🚀 Hustle KE\n\nKini unakamatia nini?`;
      }

      // Add AI response
      const aiMsg = { role: "ai", text: aiResponse, time: tstamp(), hasLink: true };
